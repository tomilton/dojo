...
public class Constant {
    ...
    public static final String COMMON_STRING_FOURTY_HUNDRED_TWENTY_TWO = "422";
    ...
    public static final String ERROR_UNPROCESSABLE_ENTITY_CODE = COMMON_STRING_FOURTY_HUNDRED_TWENTY_TWO;
    ...
    public static final String COMMON_STRING_ERROR_PARSER = "Error de parser";
    public static final String COMMON_STRING_ERROR_GENERIC = "Error generico";
