...
public class DatosRequestMdw {

    private DatosRequestMdw() {
    }
    ...
    public static RequestMdw buildRequestWithoutDataInTheBody() {
    ...
    public static PersonalInfo buildPersonalInfo() {
        ...
        personalInfo.setSecondIDNumber("");
        personalInfo.setExpeditionDate("");
    ...
    public static Customer buildCustomer() {
        ...
        customer.setLiteRegistryBrokerRQ(liteRegistryBrokerRQ);
        return customer;
    }

    public static RequestMdw buildRequestWithDataInTheBody() {
        RequestMdw requestMdw = new RequestMdw();
        RequestHeaderOut requestHeaderOut = new RequestHeaderOut();
        requestHeaderOut.setHeader(buildHeader());
        Body body = new Body();
        body.setAny(buildCustomer());
        requestHeaderOut.setBody(body);
        requestMdw.setRequestHeaderOut(requestHeaderOut);
        return requestMdw;
    }
